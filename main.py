...
class RLMarlbot:
    def __init__(self, pid=None, bot=None, minimap=True, monitoring=False, debug_keys=None,
                 built_in_kickoff=False, clock=False, debug=False):
    ...
    def initialize_bot(self):
        ...
        try:
            ...
            print(Fore.RED + "Failed to initialize bot: ", e, Style.RESET_ALL)
